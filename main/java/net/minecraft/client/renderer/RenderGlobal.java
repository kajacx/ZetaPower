...
public class RenderGlobal implements IWorldEventListener, IResourceManagerReloadListener {
    ...
    public void playEvent(EntityPlayer player, int type, BlockPos blockPosIn, int data) {
        ...
        case 2000:
            int i1 = data % 3 - 1;
            int i = data / 3 % 3 - 1;
            double d8 = blockPosIn.getX() + i1 * 0.6D + 0.5D;
        ...
        case 2004:
            ...
            for (int l1 = 0; l1 < 20; ++l1) {
                double d15 = blockPosIn.getX() + 0.5D + (this.theWorld.rand.nextFloat() - 0.5D) * 2.0D;
                double d18 = blockPosIn.getY() + 0.5D + (this.theWorld.rand.nextFloat() - 0.5D) * 2.0D;
                double d21 = blockPosIn.getZ() + 0.5D + (this.theWorld.rand.nextFloat() - 0.5D) * 2.0D;
        ...
        case 2006:
            ...
            for (int l = 0; l < 200; ++l) {
                ...
                double d3 = MathHelper.cos(f4) * f3;
                double d4 = 0.01D + random.nextDouble() * 0.5D;
                double d5 = MathHelper.sin(f4) * f3;
                Particle particle = this.spawnEntityFX(EnumParticleTypes.DRAGON_BREATH.getParticleID(), false, blockPosIn.getX() + d3 * 0.1D, blockPosIn.getY() + 0.3D, blockPosIn.getZ() + d5 * 0.1D, d3, d4, d5, new int[0]);
