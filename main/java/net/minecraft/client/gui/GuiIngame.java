...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (this.mc.gameSettings.getCamera().isFirstPerson() && itemstack != null && itemstack.getItem() == Item.getItemFromBlock(Blocks.PUMPKIN)) {
    ...
    protected void renderAttackIndicator(float p_184045_1_, ScaledResolution p_184045_2_) {
        ...
        if (gamesettings.getCamera().isFirstPerson()) {
