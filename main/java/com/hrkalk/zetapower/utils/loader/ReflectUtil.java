...
public class ReflectUtil {
    ...
    public static Method findMethod(Class clazz, final F1<Method, Boolean> f1) {
        final AtomicReference<Method> m = new AtomicReference<Method>();
        eachMethod(clazz, new com.hrkalk.zetapower.utils.loader.F1<Method, Boolean>() {
            @Override
            public Boolean e(Method obj) {
                if (f1.e(obj)) {
                    m.set(obj);
                    return true;
                }
